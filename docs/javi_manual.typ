...
#table(
  ...
  fill: (_, row) => if row == 0 { gray.lighten(85%) } else { none },
  [*Key*], [*Mode*], [*Action*],
  [#key("F1")], [Normal], [Next position in position list],
  [#key("F2")], [Normal], [File list (open buffers)],
  [#key("F3")], [Normal], [Directory list],
  [#key("F7")], [Normal], [Make (build)],
  [#key("F8")], [Normal], [Open / toggle shell],
  [#key("F8")], [Shell], [Toggle passthrough mode],
  [#key("F9")], [Normal], [LSP code completion],
  [#key("F11")], [Normal], [Toggle fullscreen],
  [#key("F12")], [Normal], [LSP go to definition],
  [#key("Shift-F12")], [Normal], [LSP find references],
  [#key("Ctrl-K")], [Normal], [LSP hover info],
  [#key("Ctrl-]")], [Normal], [Go to definition (LSP, falls back to ctags)],
  [#key("Ctrl-T")], [Normal], [Pop tag stack],
  [#key("Ctrl-L")], [Normal], [Redraw screen],
  [#key("Ctrl-G")], [Normal], [File status],
  [#key("Ctrl-^")], [Normal], [Switch to alternate file],
)
