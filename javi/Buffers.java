...
class Buffers {
   private static HashMap<Integer,Object> buflist = new HashMap<Integer,Object>();
   private static CircBuffer delbuffer = new CircBuffer(10);
   ...
   static void clearmem() {
      buflist.clear();
      delbuffer=new CircBuffer(10);
   }
   static class BuffersCmd extends Rgroup {
   final String[] rnames = {
        "",
        "enableclip",
        "paste"
   ...
   public Object doroutine(int rnum,Object arg,int count,int rcount,FvContext fvc,
        boolean dotmode) {
       switch (rnum) {
         case 1: delbuffer.enableClip(arg); return null;
         case 2: delbuffer.getclip(); return null;
         default:
...
static void deleted(char bufid,Object buffer) {
  ...
  if (buffer instanceof Object[]) {
      throw new RuntimeException("buffers deleted only does collections and strings");
  } 
  if (bufid == '0') {
//     if (buffer instanceof Object[]) {
...
//   private static class CircBuffer implements Transferable,ClipboardOwner 
   private final static class CircBuffer extends StringSelection {
      private Object[] buf;
      private int index;
      private Clipboard systemclip = java.awt.Toolkit.getDefaultToolkit().getSystemClipboard();
