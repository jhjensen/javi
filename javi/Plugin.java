...
public interface Plugin {
   public static class Loader {
      static void load(String jarFile) throws IOException,ClassNotFoundException, NoSuchFieldException,IllegalAccessException{
         try {
            ...
            trace("unable to find file " + e.getMessage());
         }
   }
static void trace(String str) {
   Tools.trace(str,1);
