...
/*
private static KeyEvent stringToEvent(String s,Component c) throws inputexception {
...
private static final KeyBinding getkb(String name,Object arg) {
...
private final static void trace(String str) {
   Tools.trace(str,1);
}
}
