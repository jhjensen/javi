...
//new Color(255,255,160);
   ...
   static final Color foldGutter = Color.GRAY;
   static final Color foldSummaryColor = Color.YELLOW;
...
//static final Color cursorColor  = Color.cyan;
   ...
   AtView(Font font, Color fg, Color bg) {
...
//     new Rectangle(5,5),ShapeGraphicAttribute.CENTER_BASELINE,true));
      by.put(TextAttribute.FOREGROUND, fg);
      by.put(TextAttribute.BACKGROUND, bg);
      byu = new HashMap<>(by);
